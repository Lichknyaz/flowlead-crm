...
) => ({ id, label, detail, timestamp, tone })

export const mockLeads: Lead[] = [
  {
    id: 'FL-1048',
    createdAt: '2026-07-22T08:42:00.000Z',
    clientName: 'Anna Novak',
    phone: '+420 731 204 118',
    ...
    message:
      'Water is leaking under the kitchen sink. I have turned off the local valve, but need someone today if possible.',
    status: 'new',
    notes: '',
    ...
    timeline: [
      ...
      event(
        ...
        'Delivered to the service team channel',
        'Today, 10:42',
        'green',
      ),
    ],
  ...
  {
    id: 'FL-1047',
    createdAt: '2026-07-22T07:18:00.000Z',
    clientName: 'Peter Svoboda',
    phone: '+420 777 310 882',
    email: 'peter.s@example.com',
    serviceType: 'Appliance installation',
    urgency: 'Standard',
    location: 'Prague 3 — Žižkov',
    preferredDate: '2026-07-25',
    message: 'New integrated dishwasher needs to be connected and checked.',
    status: 'contacted',
  ...
  {
    id: 'FL-1046',
    createdAt: '2026-07-21T14:25:00.000Z',
    clientName: 'Iryna Melnyk',
    phone: '+420 608 195 447',
    email: 'iryna.m@example.com',
    serviceType: 'Furniture assembly',
    urgency: 'Soon',
    location: 'Prague 7 — Holešovice',
    preferredDate: '2026-07-24',
    message: 'Assembly of two wardrobes and one desk from IKEA.',
    status: 'booked',
  ...
  },
  {
    ...
    clientName: 'Olena Shevchenko',
    phone: '+420 725 009 331',
    email: 'olena.s@example.com',
    serviceType: 'Small renovation',
    urgency: 'Standard',
    location: 'Prague 4 — Nusle',
    preferredDate: '2026-07-20',
    message: 'Patch and repaint one bedroom wall after shelves were removed.',
    status: 'completed',
  ...
  },
  {
    ...
    phone: '+420 739 212 009',
    email: 'david.b@example.com',
    serviceType: 'Emergency repair',
    urgency: 'Urgent',
    location: 'Prague 1 — Nové Město',
    preferredDate: '2026-07-18',
    message: 'Front door lock is jammed and cannot be secured.',
    status: 'lost',
