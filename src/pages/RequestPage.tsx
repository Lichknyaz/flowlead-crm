      ...
      <main className="request-main container">
        ...
        <div className="request-layout">
          <section className="request-intro">
            ...
            <p>
              Share a few details and our Prague team will review your request and get back to you
              with the next step.
            </p>
            <div className="response-card">
              ...
              <span>
                ...
                <small>Within 30 minutes during business hours</small>
              </span>
            </div>
            <ul className="trust-list">
              <li>
                <Check /> No call-out fee to request a quote
              </li>
              <li>
                <Check /> Vetted local technicians
              </li>
              <li>
                <Check /> Clear pricing before work begins
              </li>
            </ul>
            <div className="help-card">
              <strong>Need urgent help?</strong>
              <p>Call our service desk directly.</p>
              <a href="tel:+420212345678">
                <Phone size={17} /> +420 212 345 678
              </a>
            </div>
          </section>
          <form className="lead-form" onSubmit={submit} noValidate>
            ...
            <div className="form-heading">
              ...
              <div>
                ...
                <p>Help us send the right technician.</p>
              </div>
            </div>
            <div className="form-grid">
              <label>
              ...
              <fieldset className="full urgency-field">
                ...
                {(['Standard', 'Soon', 'Urgent'] as Urgency[]).map((item) => (
                  <button
                    type="button"
                    className={form.urgency === item ? 'selected' : ''}
              ...
              <label className="full">
                ...
                <textarea
                  ...
                  rows={5}
                />
                <small className="char-count">{form.message.length}/500</small>
